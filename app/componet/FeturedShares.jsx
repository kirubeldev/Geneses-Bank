...
// const FeturedShares = () => {
//   const [shares, setShares] = useState(10); // Default value
//   const minShares = 10;
//   const maxShares = 100;

//   // Handle input change
//   const handleInputChange = (e) => {
//     const value = Math.max(minShares, Math.min(maxShares, Number(e.target.value)));
//     setShares(value);
//   };
...
//               min={minShares}
//               max={maxShares}
//               placeholder='Min 10, Max 100 Amount of shares'
//               className='rounded-md py-1 mb-[46px] px-2 w-full md:w-[554px] h-[30px] outline-none border-none'
...
//             />
//             <div className='flex pb-5 items-center mt-[29px] justify-between text-center'>
//               <button className='border-none outline-none py-2 px-7 rounded-sm font-semibold bg-[#AF001E] text-[14px] text-white'>
//                 Invest Now
//               </button>
//               <p className='text-white text-[16px]'>100,000 ETB</p>
//             </div>
